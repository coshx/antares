package com.antares.schema;

import com.antares.results.StringResult;
...
public class Schema {
    ...
    @Procedure(name = "com.antares.schema.generate", mode = Mode.SCHEMA)
    @Description("CALL com.antares.schema.generate() - generate schema")
